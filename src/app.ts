...
import imageLibraryRoutes, {
  adminRouter as imageLibraryAdminRoutes,
} from "./modules/image-library/image-library.routes";
...
app.use("/api/admin/image-library", imageLibraryAdminRoutes);
